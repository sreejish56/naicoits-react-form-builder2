...
import { ReactFormBuilder } from '@naicoits/react-form-builder2';
import '@naicoits/react-form-builder2/dist/app.css';
...
import React from 'react';
import ReactDOM from 'react-dom';
import { ReactFormGenerator } from '@naicoits/react-form-builder2';
import '@naicoits/react-form-builder2/dist/app.css';
...
<ReactFormGenerator
    ...
    submitButton={<button type="submit" className="button button-primary">Submit</button>}
    backButton={<a href="/" className="button button-default btn-cancel btn-big">Back</a>}
/>
```

# Custom Components
- Import component registry from @naicoits/react-form-builder2
```jsx
import { ReactFormBuilder, ElementStore, Registry } from '@naicoits/react-form-builder2';
```
