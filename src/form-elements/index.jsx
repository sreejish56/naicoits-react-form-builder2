    ...
    case "H1":
      return (
        <h1
          ...
          dangerouslySetInnerHTML={{ __html: myxss.process(content) }}
        />
      );
    case "H2":
      return (
  ...
  render() {
    ...
    return (
      <div style={{ ...this.props.style }} className={baseClasses}>
        ...
        {renderHeader(headerType, classNames, this.props.data.content)}
      </div>
    );
  }
}
    ...
    return (
      <div style={{ ...this.props.style }} className={baseClasses}>
        ...
        <div className="form-group">
          ...
          this.props.defaultValue.length > 0 ? (
            <div>
              <button className="button button-default" onClick={this.saveFile}>
