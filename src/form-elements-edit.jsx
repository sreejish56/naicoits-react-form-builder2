    ...
    return (
      <div>
        <div className="flex justify-between items-center">
          ...
          <i className="fas fa-times dismiss-edit" onClick={this.props.manualEditModeOff}></i>
        </div>
        ...
        { this.props.element.hasOwnProperty('href') &&
          <div className="form-group mt-3">
            <input type="text" className="form-control" defaultValue={this.props.element.href} onBlur={this.updateElement.bind(this)} onChange={this.editElementProp.bind(this, 'href', 'value')} />
          </div>
        }
        ...
        { this.props.element.canPopulateFromApi && this.props.element.hasOwnProperty('options') &&
          <div className="form-group">
            ...
            <div className="row">
              ...
              <div className="sm:w-6/12 px-3">
                <button onClick={this.addOptions.bind(this)} className="button button-primary"><IntlMessages id="populate" /></button>
              </div>
            </div>
          </div>
        }
