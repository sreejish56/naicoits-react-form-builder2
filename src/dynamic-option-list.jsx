     ...
     return (
       <div className="dynamic-option-list">
         <ul>
           <li>
             <div className="row">
               <div className="sm:w-6/12 px-3"><b><IntlMessages id='options' /></b></div>
               { this.props.canHaveOptionValue &&
               <div className="sm:w-2/12 px-3"><b><IntlMessages id='value' /></b></div> }
               { this.props.canHaveOptionValue && this.props.canHaveOptionCorrect &&
               <div className="sm:w-4/12 px-3"><b><IntlMessages id='correct' /></b></div> }
             </div>
           </li>
           {
                   ...
                   <div className="row">
                     ...
                     <div className="sm:w-3/12 px-3">
                       <div className="dynamic-options-actions-buttons">
                         <button onClick={this.addOption.bind(this, index)} className="button button-primary"><i className="fas fa-plus-circle"></i></button>
                         { index > 0
                           && <button onClick={this.removeOption.bind(this, index)} className="button button-secondary"><i className="fas fa-minus-circle"></i></button>
                         }
                       </div>
                     </div>
                   </div>
