...
class ReactForm extends React.Component {
  ...
  handleRenderSubmit = () => {
    ...
    return submitButton || <input type='button' className='button button-primary btn-big' value={actionName} />;
  }
  ...
  handleRenderBack = () => {
    ...
    return backButton || <a href={this.props.back_action!=='/' ? this.props.back_action:'#'} className='button button-default btn-cancel btn-big'>{backName}</a>;
  }
