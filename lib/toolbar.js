...
var Toolbar = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(Toolbar, [{
    ...
    value: function create(item) {
      ...
      if (item !== null && item !== void 0 && item.canDisplayInline) {
        elementOptions.canDisplayInline = false;
      }

      if (item !== null && item !== void 0 && item.isLabelDisplaySecond) {
        elementOptions.isLabelDisplaySecond = false;
      }

      if (typeof (item === null || item === void 0 ? void 0 : item.expectedOutputFormat) !== "undefined") {
        elementOptions.expectedOutputFormat = item.expectedOutputFormat;
      } else {
        elementOptions.expectedOutputFormat = "Detailed Description";
      }

      if (typeof (item === null || item === void 0 ? void 0 : item.additionalInfoToAi) !== "undefined") {
        elementOptions.additionalInfoToAi = item.additionalInfoToAi;
      } else {
        elementOptions.additionalInfoToAi = "";
      }

      if (typeof (item === null || item === void 0 ? void 0 : item.hideLabelInPdf) !== "undefined") {
      ...
      switch (element) {
        ...
        case "LikertScale":
          return [{
            ...
            key: "likertscale_option_".concat(_UUID["default"].uuid())
          }, {
            value: "2",
            text: intl.formatMessage({
              id: "disagree"
