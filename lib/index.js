...
var ReactFormBuilder = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(ReactFormBuilder, [{
    ...
    value: function render() {
      var _this$props$imageMedi, _this$props, _this$props$videoMedi, _this$props2, _this$props$isNeedAdd, _this$props3;
      ...
      if (this.props.toolbarItems) {
        ...
        if ((0, _typeof2["default"])(currentData) === "object") {
          var imageProps = toolbarProps.items.find(function (row) {
            return row.key === "Image" || row.key === "Video";
          });
          currentData = currentData.map(function (row) {
            var rowItem = _objectSpread({}, row);

            if ((rowItem.element === "Image" || rowItem.element === "Video") && imageProps && typeof (imageProps === null || imageProps === void 0 ? void 0 : imageProps.handleUpload) !== "undefined") {
              rowItem.handleUpload = imageProps === null || imageProps === void 0 ? void 0 : imageProps.handleUpload;
            }

            if ((rowItem.element === "Image" || rowItem.element === "Video") && imageProps && typeof (imageProps === null || imageProps === void 0 ? void 0 : imageProps.handleMediaChoose) !== "undefined") {
              rowItem.handleMediaChoose = imageProps === null || imageProps === void 0 ? void 0 : imageProps.handleMediaChoose;
            }
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactDnd.DndProvider, {
        ...
        imageMediaSource: (_this$props$imageMedi = (_this$props = this.props) === null || _this$props === void 0 ? void 0 : _this$props.imageMediaSource) !== null && _this$props$imageMedi !== void 0 ? _this$props$imageMedi : [],
        videoMediaSource: (_this$props$videoMedi = (_this$props2 = this.props) === null || _this$props2 === void 0 ? void 0 : _this$props2.videoMediaSource) !== null && _this$props$videoMedi !== void 0 ? _this$props$videoMedi : [],
        isNeedAdditionalContext: (_this$props$isNeedAdd = (_this$props3 = this.props) === null || _this$props3 === void 0 ? void 0 : _this$props3.isNeedAdditionalContext) !== null && _this$props$isNeedAdd !== void 0 ? _this$props$isNeedAdd : false
