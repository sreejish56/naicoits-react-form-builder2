...
var Video = /*#__PURE__*/function (_React$Component16) {
  (0, _inherits2["default"])(Video, _React$Component16);

  var _super16 = _createSuper(Video);
  ...
  (0, _createClass2["default"])(Video, [{
    ...
    value: function render() {
      ...
      var srcCover = (_this$props$data2 = this.props.data) !== null && _this$props$data2 !== void 0 && _this$props$data2.srcCover && ((_this$props$data3 = this.props.data) === null || _this$props$data3 === void 0 ? void 0 : _this$props$data3.srcCover) != "" ? (_this$props$data4 = this.props.data) === null || _this$props$data4 === void 0 ? void 0 : _this$props$data4.srcCover : _noCoverImage["default"];
      return /*#__PURE__*/_react["default"].createElement("div", {
        style: _objectSpread(_objectSpread({}, this.props.style), style),
        className: baseClasses
      }, /*#__PURE__*/_react["default"].createElement(_componentHeader["default"], this.props), /*#__PURE__*/_react["default"].createElement("div", {
        onClick: function onClick() {
          var _this13$props$data;

          if (typeof ((_this13$props$data = _this13.props.data) === null || _this13$props$data === void 0 ? void 0 : _this13$props$data.handleView) !== "undefined") {
            var _this13$props$data2;

            (_this13$props$data2 = _this13.props.data) === null || _this13$props$data2 === void 0 ? void 0 : _this13$props$data2.handleView(_this13.props.data);
          }
        }
      }, srcCover && /*#__PURE__*/_react["default"].createElement("div", {
        className: "".concat((_this$props = this.props) !== null && _this$props !== void 0 && (_this$props$data5 = _this$props.data) !== null && _this$props$data5 !== void 0 && _this$props$data5.width ? "w-[" + ((_this$props2 = this.props) === null || _this$props2 === void 0 ? void 0 : (_this$props2$data = _this$props2.data) === null || _this$props2$data === void 0 ? void 0 : _this$props2$data.width) + "px]" : "w-full", " ").concat((_this$props3 = this.props) !== null && _this$props3 !== void 0 && (_this$props3$data = _this$props3.data) !== null && _this$props3$data !== void 0 && _this$props3$data.height ? "h-[" + ((_this$props4 = this.props) === null || _this$props4 === void 0 ? void 0 : (_this$props4$data = _this$props4.data) === null || _this$props4$data === void 0 ? void 0 : _this$props4$data.height) + "px]" : "h-[380px]", " border form-cover-image-video-tile rounded-md"),
        style: {
