...
var DynamicOptionList = /*#__PURE__*/function (_React$Component) {
  ...
  function DynamicOptionList(props) {
    ...
    _this.state = {
      element: _objectSpread({}, _this.props.element),
  ...
  (0, _createClass2["default"])(DynamicOptionList, [{
    ...
    value: function updateOption() {
      var this_element = _objectSpread({}, this.state.element); // to prevent ajax calls with no change
    ...
    value: function addOption(index) {
      ...
      this_element.options = (0, _toConsumableArray2["default"])(this_element.options);
      ...
      if (!this.props.canEditOptionValues) {
        this_element.options = this_element.options.map(function (option, index) {
