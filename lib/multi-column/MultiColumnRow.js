  ...
  (0, _createClass2["default"])(MultiColumnRowBase, [{
    ...
    value: function render() {
      ...
      var childItems = data.childItems,
          childItemsClass = data.childItemsClass,
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        var _childItemsClass$i;

        var wrapperClass = (_childItemsClass$i = childItemsClass === null || childItemsClass === void 0 ? void 0 : childItemsClass[i]) !== null && _childItemsClass$i !== void 0 ? _childItemsClass$i : className;
        return /*#__PURE__*/_react["default"].createElement("div", {
          key: "".concat(i, "_").concat(JSON.stringify(x) || "_"),
          ...
          _onDestroy: function _onDestroy(item) {
...
var TwoColumnRow = function TwoColumnRow(_ref) {
  ...
  var className = class_name || "md:w-6/12 px-3";

  if (!data.childItems) {
    // eslint-disable-next-line no-param-reassign
    data.childItems = [null, null];
    data.childItemsClass = [className, className];
...
var ThreeColumnRow = function ThreeColumnRow(_ref2) {
  ...
  var className = class_name || "md:w-4/12 px-3";

  if (!data.childItems) {
    // eslint-disable-next-line no-param-reassign
    data.childItems = [null, null, null];
    data.childItemsClass = [className, className, className];
    data.isContainer = true;
  }
...
var MultiColumnRow = function MultiColumnRow(_ref3) {
  ...
  var className = data.class_name || (colCount === 4 ? "md:w-3/12 px-3" : "col");
  ...
  if (!data.childItems) {
    ...
    data.childItemsClass = Array.from({
      length: colCount
    }, function (v, i) {
      return className;
    });
