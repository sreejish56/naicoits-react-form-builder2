  ...
  function ReactForm(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleRenderSubmit", function () {
      ...
      return submitButton || /*#__PURE__*/_react["default"].createElement("input", {
        type: "button",
        className: "button button-primary btn-big",
        value: actionName
      });
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleRenderBack", function () {
      ...
      return backButton || /*#__PURE__*/_react["default"].createElement("a", {
        href: _this.props.back_action !== "/" ? _this.props.back_action : "#",
        className: "button button-default btn-cancel btn-big"
      }, backName);
    });
  ...
  (0, _createClass2["default"])(ReactForm, [{
    ...
    value: function _isIncorrect(item) {
      ...
      if (item.canHaveAnswer) {
        ...
        if (item.element === "Checkboxes" || item.element === "RadioButtons" || item.element === "LikertScale") {
          item.options.forEach(function (option) {
        ...
        if (x) {
          if (Array.isArray(x)) {
            return x.map(function (y) {
              return _this6.getInputElement(_this6.getDataById(y));
            });
          } else {
            return _this6.getInputElement(_this6.getDataById(x));
          }
        } else {
    ...
    value: function render() {
      ...
      var items = data_items.filter(function (x) {
        ...
        item.qIndex = index + 1;
        item.isShowQuestionNumber = _this8.props.isShowQuestionNumber;
        item.isViewOnly = _this8.props.isViewOnly;
