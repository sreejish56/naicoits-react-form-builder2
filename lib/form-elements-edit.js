...
var toolbar = {
  ...
  colorPicker: {
    colors: ["rgb(37, 77, 87)", "rgb(85, 157, 179)", "rgb(200, 154, 85)", "rgb(202, 123, 84)", "rgb(164, 103, 80)", "rgb(141, 148, 104)", "rgb(128, 98, 136)", "rgb(230, 229, 227)",
    /* DEFAULT COLORS */
    // "rgb(97, 189, 109)",
    // "rgb(26, 188, 156)",
    // "rgb(84, 172, 210)",
    "rgb(44, 130, 201)", "rgb(147, 101, 184)", "rgb(71, 85, 119)", "rgb(204, 204, 204)", "rgb(65, 168, 95)", "rgb(0, 168, 133)", "rgb(61, 142, 185)", "rgb(41, 105, 176)", "rgb(85, 57, 130)", "rgb(40, 50, 78)", "rgb(0, 0, 0)", "rgb(247, 218, 100)", "rgb(251, 160, 38)", "rgb(235, 107, 86)", "rgb(226, 80, 65)", "rgb(163, 143, 132)", // "rgb(239, 239, 239)",
    "rgb(255, 255, 255)", "rgb(250, 197, 28)", "rgb(243, 121, 52)", "rgb(209, 72, 65)", "rgb(184, 49, 47)", "rgb(124, 112, 107)" // "rgb(209, 213, 216)",
    ]
  }
};
var columnSizeOptions = [{
  value: "md:w-1/12 px-3",
  label: "1/12"
}, {
  value: "md:w-2/12 px-3",
  label: "2/12"
}, {
  value: "md:w-3/12 px-3",
  label: "3/12"
}, {
  value: "md:w-4/12 px-3",
  label: "4/12"
}, {
  value: "md:w-5/12 px-3",
  label: "5/12"
}, {
  value: "md:w-6/12 px-3",
  label: "6/12"
}, {
  value: "md:w-7/12 px-3",
  label: "7/12"
}, {
  value: "md:w-8/12 px-3",
  label: "8/12"
}, {
  value: "md:w-9/12 px-3",
  label: "9/12"
}, {
  value: "md:w-10/12 px-3",
  label: "10/12"
}, {
  value: "md:w-11/12 px-3",
  label: "11/12"
}, {
  value: "md:w-full px-3",
  label: "12/12"
}];
  ...
  (0, _createClass2["default"])(FormElementsEdit, [{
    ...
    value: function editElementProp(elemProperty, targProperty, e) {
      ...
      this.setState({
        ...
        if (targProperty === "checked" || targProperty === "value" && this_element.element === "ColorPicker") {
    ...
    key: "editChildItemsClass",
    value: function editChildItemsClass(index, e) {
      var _this3 = this;
    ...
    value: function convertFromHTML(content) {
      var newContent = (0, _htmlToDraftjs["default"])(content);
    ...
    value: function MediaBrowserTile(file) {
      ...
      var contentType = file === null || file === void 0 ? void 0 : (_file$contentType = file.contentType) === null || _file$contentType === void 0 ? void 0 : _file$contentType.split("/").shift();
      ...
      switch (contentType) {
        case "image":
          return /*#__PURE__*/_react["default"].createElement("div", {
            ...
            title: file === null || file === void 0 ? void 0 : file.fileName
    ...
    value: function selectFromMediaFile(file) {
      ...
      this.props.element.handleMediaChoose(file, function (url) {
        ...
        var this_element = _objectSpread({}, _this6.state.element);
    ...
    value: function render() {
      var _this$props$element2,
          ...
          _this7 = this,
          _this$state$element$e,
          _this$state$element6;

      // if (this.state.dirty) {
      //   this.props.element.dirty = true;
      // }
      var this_checked = this.state.element.hasOwnProperty("required") ? this.state.element.required : false;
      var this_read_only = this.state.element.hasOwnProperty("readOnly") ? this.state.element.readOnly : false;
      var this_canDisplayInline = this.state.element.hasOwnProperty("canDisplayInline") ? this.state.element.canDisplayInline : false;
      var this_isLabelDisplaySecond = this.state.element.hasOwnProperty("isLabelDisplaySecond") ? this.state.element.isLabelDisplaySecond : false;
      var this_colorPickerDefaultValue = this.state.element.hasOwnProperty("defaultValue") && this.state.element.element === "ColorPicker" ? this.state.element.defaultValue : "#2f94aa";
      var this_default_today = this.state.element.hasOwnProperty("defaultToday") ? this.state.element.defaultToday : false;
      var this_show_time_select = this.state.element.hasOwnProperty("showTimeSelect") ? this.state.element.showTimeSelect : false;
      var this_show_time_select_only = this.state.element.hasOwnProperty("showTimeSelectOnly") ? this.state.element.showTimeSelectOnly : false;
      var this_show_time_input = this.state.element.hasOwnProperty("showTimeInput") ? this.state.element.showTimeInput : false;
      var this_checked_inline = this.state.element.hasOwnProperty("inline") ? this.state.element.inline : false;
      var this_checked_bold = this.state.element.hasOwnProperty("bold") ? this.state.element.bold : false;
      var this_checked_italic = this.state.element.hasOwnProperty("italic") ? this.state.element.italic : false;
      var this_checked_center = this.state.element.hasOwnProperty("center") ? this.state.element.center : false;
      var this_checked_page_break = this.state.element.hasOwnProperty("pageBreakBefore") ? this.state.element.pageBreakBefore : false;
      var this_hideLabelInPdf = this.state.element.hasOwnProperty("hideLabelInPdf") ? this.state.element.hideLabelInPdf : false;
      var this_checked_alternate_form = this.state.element.hasOwnProperty("alternateForm") ? this.state.element.alternateForm : false;
      var _this$props$element = this.props.element,
          ...
          canEditOptionValues = _this$props$element.canEditOptionValues;
      ...
      var isTextInput = this.state.element.element === "TextInput" || this.state.element.element === "EmailInput" || this.state.element.element === "PhoneNumber" || this.state.element.element === "NumberInput" || this.state.element.element === "TextArea";
      var isNeedAdditionalContext = ((_this$props$isNeedAdd = (_this$props3 = this.props) === null || _this$props3 === void 0 ? void 0 : _this$props3.isNeedAdditionalContext) !== null && _this$props$isNeedAdd !== void 0 ? _this$props$isNeedAdd : false) && isTextInput;
      var isBothPDFAndPrintOptions = isNeedAdditionalContext && canHavePageBreakBefore;
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
        ...
        stripPastedStyles: true
      }), /*#__PURE__*/_react["default"].createElement("br", null), this.props.element.hasOwnProperty("defaultValue") && this.props.element.element === "ColorPicker" && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("label", {
        className: "control-label",
        htmlFor: "is-this_colorPickerDefaultValue"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        id: "colorPickerDefaultValue"
      })), /*#__PURE__*/_react["default"].createElement("div", {
        className: "default-color-picker-wrapper"
      }, /*#__PURE__*/_react["default"].createElement("input", {
        ...
        id: "read-only"
      }))), this.props.element.hasOwnProperty("canDisplayInline") && /*#__PURE__*/_react["default"].createElement("div", {
        className: "custom-control custom-checkbox"
      }, /*#__PURE__*/_react["default"].createElement("input", {
        ...
        value: true,
        onChange: this.editElementProp.bind(this, "canDisplayInline", "checked")
      }), /*#__PURE__*/_react["default"].createElement("label", {
        className: "custom-control-label",
        htmlFor: "is-canDisplayInline"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        id: "canDisplayInline"
      }))), this.props.element.hasOwnProperty("isLabelDisplaySecond") && /*#__PURE__*/_react["default"].createElement("div", {
        className: "custom-control custom-checkbox"
      }, /*#__PURE__*/_react["default"].createElement("input", {
        ...
        value: true,
        onChange: this.editElementProp.bind(this, "isLabelDisplaySecond", "checked")
      }), /*#__PURE__*/_react["default"].createElement("label", {
        className: "custom-control-label",
        htmlFor: "is-isLabelDisplaySecond"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        id: "isLabelDisplaySecond"
        ...
        id: "show-time-input"
      }), "?")), (this.state.element.element === "RadioButtons" || this.state.element.element === "LikertScale" || this.state.element.element === "Checkboxes") && canHaveDisplayHorizontal && /*#__PURE__*/_react["default"].createElement("div", {
        className: "custom-control custom-checkbox"
      }, /*#__PURE__*/_react["default"].createElement("input", {
      ...
      }), mediaSource.filter(function (file) {
        var _file$fileName, _file$fileName$toLowe, _this7$state, _this7$state$searchMe;

        return !!(_this7.state.searchMedia === "" || file !== null && file !== void 0 && (_file$fileName = file.fileName) !== null && _file$fileName !== void 0 && (_file$fileName$toLowe = _file$fileName.toLowerCase()) !== null && _file$fileName$toLowe !== void 0 && _file$fileName$toLowe.includes((_this7$state = _this7.state) === null || _this7$state === void 0 ? void 0 : (_this7$state$searchMe = _this7$state.searchMedia) === null || _this7$state$searchMe === void 0 ? void 0 : _this7$state$searchMe.toLowerCase()));
      }).map(function (file) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          key: file === null || file === void 0 ? void 0 : file.id,
          className: (file === null || file === void 0 ? void 0 : file.url) === _this7.state.element.src ? "active-tile" : "",
          onClick: _this7.selectFromMediaFile.bind(_this7, file)
        }, _this7.MediaBrowserTile(file));
      ...
      }), ".")) : /*#__PURE__*/_react["default"].createElement("div", null), this.props.element.hasOwnProperty("childItemsClass") && /*#__PURE__*/_react["default"].createElement("div", null, this.state.element.childItemsClass.map(function (childItem, index) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          key: index,
          className: "form-group"
        }, /*#__PURE__*/_react["default"].createElement("label", {
          className: "control-label",
          htmlFor: "childItemsClass"
        }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
          id: "child"
        }), " ", index + 1, " ", /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
          id: "width"
        }), ":"), /*#__PURE__*/_react["default"].createElement("select", {
          id: "childItemsClass",
          className: "form-control",
          defaultValue: childItem,
          onChange: _this7.editChildItemsClass.bind(_this7, index)
        }, columnSizeOptions === null || columnSizeOptions === void 0 ? void 0 : columnSizeOptions.map(function (row) {
          return /*#__PURE__*/_react["default"].createElement("option", {
            value: row.value,
            key: row.value
          }, row.label);
      ...
      }), "?"))), isNeedAdditionalContext && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("hr", {
        className: "my-3.5 hr-line-gray"
      }), /*#__PURE__*/_react["default"].createElement("h5", {
        className: "text-base font-semibold !mb-0"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        id: "additional-guidance-for-ai"
      })), /*#__PURE__*/_react["default"].createElement("div", {
        className: "form-group"
      }, /*#__PURE__*/_react["default"].createElement("label", {
        className: "control-label !pt-3"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        id: "expected-output-format"
      })), /*#__PURE__*/_react["default"].createElement("select", {
        id: "expected-output-format",
        className: "form-control",
        defaultValue: (_this$state$element$e = (_this$state$element6 = this.state.element) === null || _this$state$element6 === void 0 ? void 0 : _this$state$element6.expectedOutputFormat) !== null && _this$state$element$e !== void 0 ? _this$state$element$e : "Detailed Description",
        onBlur: this.updateElement.bind(this),
        onChange: this.editElementProp.bind(this, "expectedOutputFormat", "value")
      }, ["Title/Headings", "Short Description", "Detailed Description", "Bullet Points", "Numbered Lists", "Tables", "Quotes or Callouts"].map(function (row) {
        return /*#__PURE__*/_react["default"].createElement("option", {
          value: row,
          key: row
        }, row);
        ...
        onBlur: this.updateElement.bind(this),
        onChange: this.editElementProp.bind(this, "additionalInfoToAi", "value")
      }))), isBothPDFAndPrintOptions && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("hr", {
        className: "my-3.5 hr-line-gray"
      }), /*#__PURE__*/_react["default"].createElement("h5", {
        className: "text-base font-semibold !mb-0"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        id: "pdf-or-print-options"
      }))), /*#__PURE__*/_react["default"].createElement("div", {
        className: "flex flex-wrap"
      }, isNeedAdditionalContext && /*#__PURE__*/_react["default"].createElement("div", {
        className: "md:w-1/2 w-full"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "form-group"
      }, /*#__PURE__*/_react["default"].createElement("label", {
        className: "control-label " + (isBothPDFAndPrintOptions ? "!pt-3" : "")
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        id: "pdf-options"
      })), /*#__PURE__*/_react["default"].createElement("div", {
        className: "custom-control custom-checkbox"
        ...
        value: true,
        onChange: this.editElementProp.bind(this, "hideLabelInPdf", "checked")
      }), /*#__PURE__*/_react["default"].createElement("label", {
        className: "custom-control-label",
        htmlFor: "hide-label-in-pdf"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        id: "hide-label-in-pdf"
      }), "?")))), canHavePageBreakBefore && /*#__PURE__*/_react["default"].createElement("div", {
        className: "md:w-1/2 w-full"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "form-group"
      }, /*#__PURE__*/_react["default"].createElement("label", {
      ...
      }), "?"))))), isBothPDFAndPrintOptions && /*#__PURE__*/_react["default"].createElement("hr", {
        className: "mt-3.5 hr-line-gray"
